...
tar cvfz bin/galactica-x86_64-pc-windows-gnu.tar.gz -C target/x86_64-pc-windows-gnu/release galactica.exe

shasum -a 256 bin/galactica-x86_64-apple-darwin.tar.gz
shasum -a 256 bin/galactica-aarch64-apple-darwin.tar.gz
shasum -a 256 bin/galactica-x86_64-pc-windows-gnu.tar.gz